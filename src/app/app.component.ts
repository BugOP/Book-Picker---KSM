...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(public router: Router, private metaService : Meta, public gv: GlobalVar, public mo: MediaObserver) { }
  IsLoggedIn() {
  ...
  RouterAction() {
    ...
    else if (this.current_url === '/select-genre') {
      this.IsLoggedIn()
    ...
    else if (this.current_url === '/login') {
    ...
    else if (this.current_url === '/location') {
      this.IsLoggedIn()
      this.menu_icon = false;
      this.color = "accent";
      this.nav_bar = false;
    ...
    else if (this.current_url === '/profile') {
      this.IsLoggedIn()
      if (this.gv.deviceXs){
        this.close()
      }
    ...
    else if (this.current_url === '/your-books') {
      this.IsLoggedIn()
      if (this.gv.deviceXs){
        this.close()
      }
    ...
    }else if (this.current_url === '/add-book') {
      this.IsLoggedIn()
      if (this.gv.deviceXs){
        this.close()
      }
    ...
    else if (this.current_url === '/settings') {
      this.IsLoggedIn()
      if (this.gv.deviceXs){
        this.close()
      }
    ...
    else if (this.current_url === '/home/book-info' || this.current_url === '/your-books/book-info') {
      this.IsLoggedIn()
      if (this.gv.deviceXs){
        this.close()
      }
    ...
    else if (this.current_url === '/nickname') {
      this.login_button = false
      this.menu_icon = false;
      this.color = "accent";
      this.nav_bar = false;
